...
<template>
    <div class="loading-container">
        <div class="loading">
            <svg class="rotating" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            width="92px" height="92px" viewBox="0 0 92 92" enable-background="new 0 0 92 92" xml:space="preserve">
            <path fill="#FFFFFF" id="XMLID_93_" d="M46,25.7c-2.2,0-4-1.8-4-4V4.5c0-2.2,1.8-4,4-4s4,1.8,4,4v17.2C50,23.9,48.2,25.7,46,25.7z M34.1,29.6
